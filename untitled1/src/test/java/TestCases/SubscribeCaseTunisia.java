...
public class SubscribeCaseTunisia extends supportClass {
...
//sorry i do not have much time to do it, but it is same mechanism to classic test
    ...
    if (supportClassObj.getCurrentCountry().equalsIgnoreCase("Oman")) {
        Assert.assertEquals(homePageElementsObject.getLitePrice().getText(), "1.7");
    }
}
...
//sorry i do not have much time to do it, but it is same mechanism to classic test
    ...
    if (supportClassObj.getCurrentCountry().equalsIgnoreCase("Oman")) {
        Assert.assertEquals(homePageElementsObject.getPremiumPrice().getText(), "5.8");
    }
    }
