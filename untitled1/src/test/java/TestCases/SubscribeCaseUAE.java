...
public class SubscribeCaseUAE extends supportClass {
...
//sorry i do not have much time to do it, but it is same mechanism to classic test
    ...
    if (supportClassObj.getCurrentCountry().equalsIgnoreCase("Oman")) {
        Assert.assertEquals(homePageElementsObject.getLitePrice().getText(), "5.4");
    }
}
...
//sorry i do not have much time to do it, but it is same mechanism to classic test
    ...
    if (supportClassObj.getCurrentCountry().equalsIgnoreCase("Oman")) {
        Assert.assertEquals(homePageElementsObject.getPremiumPrice().getText(), "16.3");
    }
    }
