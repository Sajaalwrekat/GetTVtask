...
public class SubscribeAllCountries extends supportClass {
...
public void generalSetup() throws InterruptedException {
    ...
    //should make loop to set country oman, do all test, change country to Tunisia, do all test, change country to UAE, do all test
    //supportClassObj.selectCountry("Oman");
    //IMPORTNANT NOTE DEAR REVIEWER:  please dear review test all country when u run code by change set country value to Tunisia, then UAE, i know it is have to be auto looping, but unfour i do not have much time
    //supportClassObj.selectCountry("Tunisia");
    supportClassObj.selectCountry("UAE");
...
@Test
 public void checkLitePackagePerCountry(){
//sorry i do not have much time to do it, but it is same mechanism to classic test
}

@Test
public void checkPremiumPackagePerCountry(){
//sorry i do not have much time to do it, but it is same mechanism to classic test
    }
